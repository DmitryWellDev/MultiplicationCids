...
export const Multiple2 = () => {
    ...
    let [arrayOfTasks, setArrayOfTasks] = useState<Array<{mult: number, isWrong: boolean}>>([])
    ...
    useEffect(() => {
        let arrayOfTasks: Array<{mult: number, isWrong: boolean}> = []
        for (let i: number = 1; i < 11; i++) {
            arrayOfTasks.push({mult: i, isWrong: false})
